...
<FieldNote prompt="What kind of agent did you build this for (keep it generic), and at what point did full history start to hurt: how many turns, how many tokens, what latency?" />
...
<FieldNote prompt="A memory bug you hit: the agent remembered something wrong, forgot something important, or mixed up users. What caused it?" />
...
<FieldNote prompt="Which store and framework did you actually use, and what would you choose differently next time?" />
