...
<FieldNote prompt="Describe one retrieval bug you traced back to chunking. What kind of document was it (keep it generic), what went wrong, and how did you find it?" />
...
<FieldNote prompt="Contextual headers or late chunking: which have you actually run? What did it cost at ingestion, and was the improvement worth it?" />
...
<FieldNote prompt="On a real project, what chunk size and overlap did you end up with, and what did you start with?" />
